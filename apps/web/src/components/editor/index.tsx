...
import { EV, EVENTS } from "@notesfriend/core";
import { db } from "../../common/db";
import Titlebox, { resizeTextarea } from "./title-box";
import Config from "../../utils/config";
import { ScopedThemeProvider } from "../theme-provider";
import { showToast } from "../../utils/toast";
import { Item, MaybeDeletedItem, isDeleted } from "@notesfriend/core";
import { debounce, debounceWithId } from "@notesfriend/common";
import { Freeze } from "react-freeze";
import { UnlockView } from "../unlock";
import DiffViewer from "../diff-viewer";
import TableOfContents from "./table-of-contents";
import { scrollIntoViewById } from "@notesfriend/editor";
  ...
  return (
    <EditorChrome {...props}>
      <Tiptap
        ...
        content={content}
        downloadOptions={{
          corsHost: Config.get("corsProxy", "https://cors.notesfriend.com")
        }}
        onLoad={(editor) => {
