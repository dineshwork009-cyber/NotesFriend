...
const social = [
  ...
  },
  {
    ...
    hoverColor: "#1da1f2",
    icon: Twitter,
    link: "https://twitter.com/notesfriend"
  },
  {
    title: "Reddit",
    hoverColor: "#ff4500",
    icon: Reddit,
    link: "https://reddit.com/r/Notesfriend"
  }
];
function BlogPromoBanner() {
  return (
    ...
    >
      ...
      {/* <p>
        Listen. We want you to buy Notesfriend Pro. It's as simple as that. Since
      ...
      <p>
        We want you to buy Notesfriend Pro. Not to line our own pockets but to
        bring a change. Instead of. We want to hear that phrase. "I bought
        Notesfriend instead of Evernote". For us, that is success.
      </p>
      <p>
...
//         We started out building Notesfriend in November 2019. Our mission was to
