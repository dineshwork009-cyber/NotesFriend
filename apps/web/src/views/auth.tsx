...
import { AuthenticatorType, User } from "@notesfriend/core";
    ...
    >
      {(form?: EmailFormData) => (
        <>
          ...
          <Flex sx={{ alignItems: "center", width: "100%", my: 3 }}>
            <Box sx={{ flex: 1, height: "1px", bg: "border" }} />
            <Text
              mx={2}
              variant="subBody"
              sx={{ color: "var(--paragraph-secondary)", whiteSpace: "nowrap", fontSize: 11 }}
            >
              or
            </Text>
            <Box sx={{ flex: 1, height: "1px", bg: "border" }} />
          ...
          <Button
            ...
            onClick={async () => {
              await userstore.tryDemo();
              openURL("/", { authenticated: true });
            }}
          >
            ✦ Try Demo — Full Access, No Account Needed
          </Button>
        </>
      )}
    </AuthForm>
        ...
        <>
          ...
          >
            ...
            <Link
              target="_blank"
              rel="noreferrer"
              href="https://notesfriend.com/tos"
              sx={{ color: "accent" }}
            >
            ...
            <Link
              rel="noreferrer"
              href="https://notesfriend.com/privacy"
              sx={{ color: "accent" }}
            >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text
          variant="heading"
          sx={{ fontSize: 28, textAlign: "left", lineHeight: 1.2 }}
        >
          {title}
        </Text>
        {subtitle && (
        ...
        {canSkip && (
          <Button
            type="button"
            variant="anchor"
            sx={{ mt: 4, color: "var(--paragraph-secondary)", fontSize: 13 }}
            onClick={() => {
      ...
      <Text
        variant="subBody"
        mt={4}
        sx={{ textAlign: "center", fontSize: 11, color: "var(--paragraph-secondary)" }}
      >
        Designed by{" "}
        <Button
          as="a"
          variant="anchor"
          href="https://dineshsarikonda.com"
          target="_blank"
