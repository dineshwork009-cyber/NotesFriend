...
import { Period, SubscriptionPlan } from "@notesfriend/core";
...
import { getFeaturesTable, planToAvailability } from "@notesfriend/common";
...
const testimonial = {
  ...
  text: "I'm pretty impressed at the progress @notesfriend are making on their app — particularly in respect to how performant the app runs and behaves, despite the overhead of end-to-end encrypting user data."
};
...
const FEATURED_ON = [
  ...
  },
  {
    id: "itsfoss",
    logo: ItsFoss,
    link: "https://news.itsfoss.com/standard-notes-to-notesfriend/"
  },
  {
    id: "Hackernoon",
    logo: Hackernoon,
...
const RECOMMENDED_BY = [
  {
    ...
    logo: PrivacyGuides,
    size: 45,
    link: "https://www.privacyguides.org/en/notebooks/#notesfriend"
  },
  {
    id: "techlore",
    logo: Techlore,
  ...
  },
  {
    ...
    link: "https://freedom.press/digisec/blog/note-taking-security/#notesfriend"
  }
];
