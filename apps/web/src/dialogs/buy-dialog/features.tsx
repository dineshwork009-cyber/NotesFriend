...
const sections: Section[] = [
  {
    ...
    detail:
      "Everything you do in Notesfriend stays private. We use XChaCha20-Poly1305-IETF and Argon2 to encrypt your notes.",
    features: [
      {
        id: "zero-ads",
  ...
  },
  {
    ...
    detail: "Notesfriend is available on all major platforms — for everyone.",
    columns: 8,
  ...
  {
    title: "Personalize & make Notesfriend your own",
    detail:
