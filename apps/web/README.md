<p align="center">
<img style="align:center;" src="/resources/screenshots/web.jpg" alt="Notesfriend web screenshot" width="600" />
</p>

<h1 align="center">Notesfriend Web</h1>
<h3 align="center">The web app is built using React, Typescript & Javascript.</h3>
<p align="center">
<a href="https://app.notesfriend.com/">Try it out!</a> | <a href="#developer-guide">Developer guide</a> | <a href="#build-instructions">How to build?</a> | <a href="../desktop/">Desktop app</a>
</p>
...
```bash
git clone https://github.com/streetwriters/notesfriend.git

# change directory
cd notesfriend
```

Once you are inside the `./notesfriend` directory, run the preparation step:
...
1. `src/`: 99% of the source code lives here & this is also where you'll spend most of your time.
   ...
   7. `interfaces/`: This is where the **platform-specific storage & encryption logic** lives. These interface implementations are used by the `@notesfriend/core` to provide capabilities such as persistence & encryption.
