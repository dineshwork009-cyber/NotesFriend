...
const productName = process.env.NN_PRODUCT_NAME || "Notesfriend";
const appId = process.env.NN_APP_ID || "org.streetwriters.notesfriend";
...
module.exports = {
  ...
  copyright: `Copyright © ${year} Dines`,
  artifactName: "notesfriend_${os}_${arch}.${ext}",
  ...
  portable: {
    artifactName: "notesfriend_${os}_${arch}_portable.${ext}"
  },
  nsis: {
    oneClick: true,
