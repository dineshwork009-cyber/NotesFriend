...
>;
const SOCIAL_LINKS = [
  { id: "X/Twitter", icon: mdiTwitter, href: "https://twitter.com/notesfriend" },
  { id: "Reddit", icon: mdiReddit, href: "https://www.reddit.com/r/notesfriend" },
  {
    id: "Telegram",
  ...
  },
  {
    id: "Mastodon",
    icon: mdiMastodon,
    href: "https://fosstodon.org/@notesfriend"
  }
];
...
const footerLinks = [
  ...
  },
  {
    title: "Blog",
    type: "link",
    href: "https://blog.notesfriend.com/"
  },
  {
    title: "About",
    type: "link",
    href: "https://notesfriend.com/about"
  }
];
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              ...
              <Text variant="subBody">
                {subtitle || "A product of Notesfriend"}
              </Text>
            </Flex>
          </Flex>
      ...
      >
        ...
        <Flex sx={{ gap: 2 }}>
          <Link variant="text.subBody" href="https://notesfriend.com/privacy">
            Privacy Policy
          </Link>
          <Link variant="text.subBody" href="https://notesfriend.com/terms">
            Terms of Service
          </Link>
        </Flex>
      </Flex>
