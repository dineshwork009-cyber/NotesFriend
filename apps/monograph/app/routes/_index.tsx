...
const features = [
  {
    name: "Share notes",
    body: `Share a note with anyone on the internet even if they do not use Notesfriend using a private sharable url.`,
      ...
      >
        ...
        >
          ...
          <ButtonLink
            ...
            href="https://help.notesfriend.com/publish-notes-with-monographs"
            target="_blank"
          >
            How it works
          </ButtonLink>
