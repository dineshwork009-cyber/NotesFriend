import { Plan, SKUResponse } from "@notesfriend/core";
      ...
      >
        {[
          Config.GITHUB_RELEASE === "true"
            ? "yearly"
            : `notesfriend.${props.planId}.yearly`,
          Config.GITHUB_RELEASE === "true"
            ? "monthly"
            : `notesfriend.${props.planId}.monthly`,
          ...(props.planId === "essential" || pricingPlans.isSubscribed()
            ? []
            : [
                Config.GITHUB_RELEASE === "true"
                  ? "5-year"
                  : `notesfriend.${props.planId}.5year`
              ])
        ].map((item) => (
          <ProductItem
            key={item}
        ...
        >
          ...
          <Text
            ...
            onPress={() => {
              openLinkInBrowser("https://notesfriend.com/privacy");
            }}
          >
            {strings.subTerms[1]()}
          </Text>{" "}
          ...
          <Text
            ...
            onPress={() => {
              openLinkInBrowser("https://notesfriend.com/tos");
            }}
          >
            {strings.subTerms[3]()}
          </Text>
                ...
                {strings.percentOff(
                  (regionalDiscount
                    ...
                    : props.pricingPlans.compareProductPrice(
                        props.pricingPlans.currentPlan?.id as string,
                        `notesfriend.${props.pricingPlans.currentPlan?.id}.yearly`,
                        `notesfriend.${props.pricingPlans.currentPlan?.id}.monthly`
                      )) as string
                )}
              </Heading>
            </View>
