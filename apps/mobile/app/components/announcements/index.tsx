 ...
 * {
    ...
    body: [
      ...
      {
        type: "description",
        text: "Most of you are too busy to keep up to date with what's happening in Notesfriend. That is unfortunate because Notesfriend has come a looooong way.",
        style: {
          marginBottom: 1
        },
        platforms: ["all"]
      ...
      {
        type: "description",
        text: "To solve this, we are launching the Notesfriend Digest — a newsletter to help you stay updated about Notesfriend development. And to keep things interesting I'll also sprinkle this newsletter with other interesting stuff like privacy tips & news, interesting books, things I am looking forward to etc.",
        style: {
          marginBottom: 1
        },
        platforms: ["all"]
        ...
        actions: [
          {
            ...
            title: "15% Off",
            platforms: ["android"],
            data: "com.streetwriters.notesfriend.sub.yr.15"
          }
        ],
        platforms: ["all"]
      }
