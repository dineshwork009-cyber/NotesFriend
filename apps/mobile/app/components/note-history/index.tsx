...
import { getFormattedDate, getTimeAgo } from "@notesfriend/common";
import { HistorySession, Note, VirtualizedGrouping } from "@notesfriend/core";
    ...
    <View>
      ...
      >
        ...
        <Text
          onPress={() => {
            openLinkInBrowser(
              "https://help.notesfriend.com/note-version-history"
            );
          }}
          style={{
            color: colors.primary.accent,
