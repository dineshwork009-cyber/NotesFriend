import { getFeaturesTable } from "@notesfriend/common";
import {
  EV,
  EVENTS,
  Plan,
              ...
              >
                ...
                >
                  {pricingPlans.isSubscribed()
                    ? strings.changePlan()
                    : strings.notesfriendPlans[0]() + " "}
                  {pricingPlans.isSubscribed() ? null : (
                    <Heading
                      size={AppFontSize.xl}
                      color={colors.primary.accent}
                    >
                      {strings.notesfriendPlans[1]()}
                    </Heading>
                  )}
                </Heading>
              </View>
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() => {
                    openLinkInBrowser(
                      "https://github.com/streetwriters/notesfriend/stargazers"
                    );
                  }}
                  activeOpacity={0.9}
                  style={{
                ...
                <TouchableOpacity
                  onPress={() => {
                    openLinkInBrowser(
                      "https://www.privacyguides.org/en/notebooks/#notesfriend"
                    );
                  }}
                  activeOpacity={0.9}
                  style={{
...
After trying all the privacy security oriented note taking apps, for the price and the features afforded to your users, Notesfriend is hands down the best.`}
                />
              </View>
            </View>
            <View
  ...
  const product =
    plan.subscriptions?.[
      regionalDiscount?.sku ||
        `notesfriend.${plan.id}.${annualBilling ? "yearly" : "monthly"}`
    ];
