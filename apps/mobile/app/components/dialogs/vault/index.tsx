...
import { Note, NoteContent, VAULT_ERRORS } from "@notesfriend/core";
          ...
          !state.revokeFingerprintAccess ? (
            <>
              <Input
                ...
                editable={!loading}
                autoCapitalize="none"
                testID={notesfriend.ids.dialogs.vault.pwd}
                onChangeText={(value) => {
          ...
          {changePassword ? (
            <>
              ...
              <Input
                ...
                editable={!loading}
                testID={notesfriend.ids.dialogs.vault.changePwd}
                autoCapitalize="none"
                onChangeText={(value) => {
          ...
          {!novault ? (
            <View>
              ...
              <Input
                fwdRef={confirmPassRef}
                autoCapitalize="none"
                testID={notesfriend.ids.dialogs.vault.pwdAlt}
                secureTextEntry
