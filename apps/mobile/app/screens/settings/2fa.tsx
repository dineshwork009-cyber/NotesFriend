import { sanitizeFilename, useIsFeatureAvailable } from "@notesfriend/common";
import { strings } from "@notesfriend/intl";
import { useThemeColors, VariantsWithStaticColors } from "@notesfriend/theme";
          ...
          >
            ...
            <Button
              ...
              onPress={async () => {
                try {
                  let path;
                  let fileName = "notesfriend_recoverycodes";
