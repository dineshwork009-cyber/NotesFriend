...
export const settingsGroups: SettingSection[] = [
  {
    ...
    sections: [
      ...
      {
        id: "notesfriend-circle",
        name: strings.notesfriendCircle(),
        icon: "circle-outline",
        type: "screen",
        description: strings.notesfriendCircleDesc(),
        component: "notesfriend-circle"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        inputProperties: {
          defaultValue: "https://cors.notesfriend.com",
          autoCorrect: false,
          keyboardType: "url"
        },
        property: "corsProxy",
      ...
      },
      {
        ...
        modifer: () => {
          ...
          if (Platform.OS === "ios") {
            ...
            NotesfriendModule.setSecureMode(!settings.privacyScreen);
          }
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: "email",
        modifer: () => {
          Clipboard.setString("support@notesfriend.app");
          ToastManager.show({
          ...
          setTimeout(() => {
            Linking.openURL("mailto:support@notesfriend.app");
          }, 1000);
        },
      ...
      },
      {
        ...
        modifer: async () => {
          Linking.openURL("https://help.notesfriend.com/");
        },
    ...
    sections: [
      {
        ...
        modifer: () => {
          Linking.openURL("https://t.me/notesfriend").catch(() => {
            /* empty */
          });
        }
      },
      {
        ...
        icon: "mastodon",
        modifer: () => {
          Linking.openURL("https://fosstodon.org/@notesfriend").catch(
            console.log
          );
        }
      },
      {
        ...
        icon: "twitter",
        modifer: () => {
          Linking.openURL("https://twitter.com/notesfriend").catch(() => {
            /* empty */
          });
        }
      },
    ...
    sections: [
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://notesfriend.com/tos");
          } catch (e) {
            console.error(e);
          }
        },
      ...
      },
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://notesfriend.com/privacy");
          } catch (e) {
            console.error(e);
          }
        },
    ...
    sections: [
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://notesfriend.com/downloads");
          } catch (e) {
            console.error(e);
          }
        },
      ...
      },
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://notesfriend.com/roadmap/");
          } catch (e) {
            console.error(e);
          }
        },
      ...
      },
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://notesfriend.com");
          } catch (e) {
            console.error(e);
          }
        },
