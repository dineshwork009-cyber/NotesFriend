...
import { format, LogLevel, logManager } from "@notesfriend/core";
import { strings } from "@notesfriend/intl";
import { LogMessage } from "@notesfriend/logger";
...
export default function DebugLogs() {
  ...
  const downloadLogs = React.useCallback(async () => {
    try {
      let path = null;
      const fileName = sanitizeFilename(`notesfriend_logs_${Date.now()}`);
