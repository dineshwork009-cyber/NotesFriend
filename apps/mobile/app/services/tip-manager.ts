...
const placeholderTips = [
  ...
  "Get Notesfriend on all your devices. Or even open it in browser by going to https://app.notesfriend.com to access all your notes",
  "With note history, you can restore back to an older version of the note if you accidentally deleted something.",
  "When your heart speaks, take good notes. - Judith Campbell",
  "You can publish a note and share it with anyone. Even if they don't use Notesfriend!",
