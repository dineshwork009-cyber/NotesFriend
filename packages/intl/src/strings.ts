...
export const strings = {
  ...
  analyticsPermissionText: {
    0: () => t`Help improve Notesfriend by sending completely anonymized`,
  ...
  monographLearnMore: () => t`Learn more about Notesfriend Monograph`,
  rateAppHeading: () => t`Do you enjoy using Notesfriend?`,
  rateAppDesc: () =>
    t`It took us a year to bring Notesfriend to life. Share your experience and suggestions to help us improve it.`,
...
$day$: Current day (eg. Monday)`,
  ...
  issueDesc2: () =>
    t`Let us know if you have faced any issue/bug while using Notesfriend. We will try to fix it as soon as possible.`,
  migrationSaveBackup: () => t`Save a backup of your notes`,
  migrationSaveBackupDesc: () =>
    t`Thank you for updating Notesfriend! We will be applying some minor changes for a better note taking experience.`,
  ...
  subscriptionProviderInfo: {
    0: {
      ...
      desc: () =>
        t`You were awarded a subscription to Notesfriend Pro by Streetwriters.`
    },
    1: {
      type: "iOS",
      title: () => t`Subscribed on iOS`,
      desc: () =>
        t`You subscribed to Notesfriend Pro on iOS using Apple In App Purchase. You can cancel anytime with your iTunes Account settings.`,
      icon: "ios"
    },
    2: {
      type: "Android",
      ...
      desc: () =>
        t`You subscribed to Notesfriend Pro on Android Phone/Tablet using Google In App Purchase.`,
      icon: "android"
    },
    3: {
      type: "Web",
      title: () => t`Subscribed on Web`,
      desc: () => t`You subscribed to Notesfriend Pro on the Web/Desktop App.`,
      icon: "web"
    },
    4: {
      type: "Gift card",
      title: () => t`Subscribed using gift card`,
      desc: () => t`You subscribed to Notesfriend Pro using a gift card.`
    }
  },
  dark: () => t`Dark`,
  light: () => t`Light`,
  ...
  fileSaved: (name: string, platform: string) =>
    select(platform, {
      ...
      other: `${name} saved to File Manager/Notesfriend/downloads`
    }),
  ...
  introData: [
    ...
    },
    {
      ...
      body: () =>
        t`Your privacy matters to us, no matter who you are. In a world where everyone is trying to spy on you, Notesfriend encrypts all your data before it leaves your device. With Notesfriend no one can ever sell your data again.`
    },
    {
      tesimonial: () =>
        t`You simply cannot get any better of a note taking app than @notesfriend. The UI is clean and slick, it is feature rich, encrypted, reasonably priced (esp. for students & educators) & open source`,
  ...
  mfaEmailDesc: () =>
    t`Notesfriend will send you a 2FA code on your email when prompted`,
  mfaEmailSubtitle: () =>
  ...
  mfaSmsDesc: () =>
    t`Notesfriend will send you an SMS with a 2FA code when prompted`,
  ...
  notesfriendPro: () => t`Notesfriend Pro`,
  subscribedOnVerify: (date: string) =>
    t`You subscribed to Notesfriend Pro on ${date}. Verify this subscription?`,
  verifySubscription: () => t`Verify subscription`,
  subscriptionVerifyWait: () =>
    t`Please wait while we verify your subscription`,
  verifySubDesc: () => t`Verify your subscription to Notesfriend Pro`,
  logoutWarnin: () =>
  ...
  forcePullChangesDesc: () =>
    [
      ...
      "",
      t`This must only be used for troubleshooting. Using it regularly for sync is not recommended and will lead to unexpected data loss and other issues. If you are having persistent issues with sync, please report them to us at support@notesfriend.app.`
    ].join("\n"),
  forceSyncNotice: () =>
    `This must only be used for troubleshooting. Using this regularly for sync is not recommended and will lead to unexpected data loss and other issues. If you are having persistent issues with sync, please report them to us at support@notesfriend.app.`,
  ...
  telemetryDesc: () =>
    t`Contribute towards a better Notesfriend. All tracking information is anonymous.`,
  ...
  emailSupportDesc: () =>
    t`Contact us directly via support@notesfriend.app for any help or support`,
  documentation: () => t`Documentation`,
  documentationDesc: () =>
    t`Read the documentation to learn more about Notesfriend`,
  ...
  joinMastodonDesc: () =>
    t`Follow us on Mastodon for updates and news about Notesfriend`,
  followOnX: () => t`Follow us on X`,
  followOnXDesc: () => t`Follow us on X for updates and news about Notesfriend`,
  ...
  ossLibs: () => t`Open source libraries used in Notesfriend`,
  about: () => t`About`,
  downloadOnDesktop: () => t`Download on desktop`,
  downloadOnDesktopDesc: () =>
    t`Get Notesfriend app on your desktop and access all notes`,
  roadmap: () => t`Roadmap`,
  roadmapDesc: () => t`See what the future of Notesfriend is going to be like.`,
  checkForUpdates: () => t`Check for updates`,
  checkForUpdatesDesc: () => t`Check for new version of Notesfriend`,
  ...
  subNotSupported: () =>
    t`This version of Notesfriend app does not support in-app purchases. Kindly login on the Notesfriend web app to make the purchase.`,
  ...
  backupSaved: (platform: string) =>
    select(platform, {
      android: 'Backup file saved in "Notesfriend backups" folder on your phone.',
      other: "Backup file is saved in File Manager/Notesfriend folder"
    }),
  ...
  backupDataDesc: () =>
    t`All your backups are stored in 'Phone Storage/Notesfriend/backups/' folder`,
  ...
  rateAppActionText: (platform: string) =>
    platform === "ios"
      ? t`Rate Notesfriend on App Store`
      : t`Rate Notesfriend on Play Store`,
  ...
  autoBackupsOffActionText: () =>
    t`Get Notesfriend Pro to enable automatic backups`,
  ...
  notificationsDisabledDesc: () =>
    t`Reminders cannot be set because notifications have been disabled from app settings. If you want to keep receiving reminder notifications, enable notifications for Notesfriend from app settings.`,
  openSettings: () => t`Open settings`,
  close: () => t`Close`,
  getNotesfriendPro: () => t`Get Notesfriend Pro`,
  colorsProMessage: () => t`Unlock more colors with Notesfriend Pro`,
  exportProMessage: () =>
    t`Export notes as PDF, Markdown and HTML with Notesfriend Pro`,
  tagsProMessage: () => t`Create unlimited tags with Notesfriend Pro`,
  notebookProMessage: () => t`Create unlimited notebooks with Notesfriend Pro`,
  vaultProMessage: () => t`Create unlimited vaults with Notesfriend Pro`,
...
- Things you have tried etc.`,
  ...
  savingNoteTakingTooLong: () =>
    t`Saving this note is taking too long. Copy your changes and restart the app to prevent data loss. If the problem persists, please report it to us at support@notesfriend.app.`,
  changesNotSavedDesc: () =>
  ...
  selectFolderForBackupFilesDesc: () =>
    t`Select folder where Notesfriend backup files are stored to view and restore them from the app`,
  ...
  installNotesfriend: () => t`Install Notesfriend`,
  installNotesfriendDesc: (platform: string) =>
    t`For a more integrated user experience, try out Notesfriend for ${platform}`,
  nativeFeatures: () => [
  ...
  importerHelpText: () => [
    ...
    t`import guide`,
    t`for help regarding how to use the Notesfriend Importer.`
  ],
  ...
  betaLoginNotice: () =>
    t`You are logging into the beta version of Notesfriend. Switching between beta &amp; stable versions can cause weird issues including data loss. It is recommended that you do not use both simultaneously.`,
  ...
  shareWithFriends: () => t`Share Notesfriend with friends!`,
  tagPromoWinText: () => [
    t`Use`,
    t`#notesfriend`,
  ...
  backupFileMethodDesc: () =>
    t`If you don't have a recovery key, you can recover your data by restoring a Notesfriend data backup file (.nnbackup).`,
...
**Only use this for troubleshooting purposes. If you are having persistent issues, it is recommended that you reach out to us via support@notesfriend.app so we can help you resolve it permanently.**`,
  ...
  upgradeToProToUseFeature: (feature = "default") => {
    const features = {
      color: t`Upgrade to Notesfriend Pro to add colors.`,
      tags: t`Upgrade to Notesfriend Pro to create more tags.`,
      notebook: t` Upgrade to Notesfriend Pro to add more notebooks.`,
      vault: t` Upgrade to Notesfriend Pro to use the notes vault.`,
      customPresets: t` Upgrade to Notesfriend Pro to use custom toolbar presets.`,
      customizeToolbar: t` Upgrade to Notesfriend Pro to customize the toolbar.`,
      default: t` Upgrade to Notesfriend Pro to use this feature.`
    };
...
If your issue is critical (e.g. notes not syncing, crashes etc.), please [join our Discord community](https://discord.com/invite/zQBK97EE22) for one-to-one support.`,
  ...
  encryptsEverything: () =>
    t`Notesfriend encrypts everything offline before syncing to your other devices. This means that no one can read your notes except you. Not even us.`,
  ...
  welcomeToNotesfriendPro: () => t`Welcome to Notesfriend Pro`,
  thankYouPrivacy: () =>
  ...
  autoStartDescription: () =>
    t`If true, Notesfriend will automatically start up when you turn on & login to your system.`,
  startMinimized: () => t`Start minimized`,
  startMinimizedDescription: () =>
    t`If true, Notesfriend will start minimized to either the system tray or your system taskbar/dock. This setting only works with Auto start on system startup is enabled.`,
  ...
  notesfriendImporter: () => t`Notesfriend Importer`,
  ...
  sourceCodeDescription: () =>
    t`All the source code for Notesfriend is available & open for everyone on GitHub.`,
  ...
  availableOnIOSDescription: () =>
    t`Get Notesfriend app on your iPhone and access all your notes on the go.`,
  availableOnIOSAndAndroidDescription: () =>
    t`Get Notesfriend app on your iPhone or Android device and access all your notes on the go.`,
  ...
  customDnsDescription: () =>
    t`Notesfriend uses the following DNS providers:

1. Cloudflare DNS
2. Quad9

This can sometimes bypass local ISP blockages on Notesfriend traffic. Disable this if you want the app to use system's DNS settings.`,
...
**These must only be used for troubleshooting. Using them regularly for sync is not recommended and will lead to unexpected data loss and other issues. If you are having persistent issues with sync, please report them to us at support@notesfriend.app.**`,
  ...
  usingOfficialInstance: () => t`Using official Notesfriend instance`,
  ...
  serversConfigurationDesc: () => t`Configure server URLs for Notesfriend`,
  ...
  releaseTrackDesc: () => t`Select the release track for Notesfriend.`,
  stable: () => t`Stable`,
  beta: () => t`Beta`,
  zoom: () => t`Zoom`,
  ...
  notesfriendPlans: [() => t`Notesfriend`, () => t`Plans`],
  readyToTakeNextStep: () =>
  ...
  welcomeToPlan: (plan: string) => t`Welcome to Notesfriend ${plan}`,
  ...
  notesfriendCircle: () => t`Notesfriend Circle`,
  notesfriendCircleDesc: () =>
    t`Notesfriend Circle brings together trusted partners who share our commitment to privacy, transparency, and user freedom.`,
  trialUserCircleNotice: () =>
    `Notesfriend Circle is reserved for members with an active subscription. You'll get full access after your trial period is over and your subscription is confirmed.`,
  freeUserCircleNotice: () =>
    t`The Notesfriend Circle is exclusive to subscribers. Please consider subscribing to gain access to Notesfriend Circle and enjoy additional benefits.`,
  ...
  loginToUploadAttachments: () =>
    t`Login to upload attachments. [Read more](https://help.notesfriend.com/faqs/login-to-upload-attachments)`,
  views: () => t`Views`,
