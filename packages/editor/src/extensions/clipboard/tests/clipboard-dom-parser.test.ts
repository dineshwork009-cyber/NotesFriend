...
and yet, we somehow manage to get by.<br>
  ...
  [
    ...
    Also when I share the selection to Notesfriend via the share functionality from Android, I have the same issue.</p>
    <hr>
  ...
  [
    `<div>
    <!--StartFragment--><meta charset="utf-8"><h1><span >Write notes</span></h1><br><p dir="ltr" ><span >Welcome of </span><a><span >Notesfriend</span></a><span >, an syncing.</span></p><br><p dir="ltr" ><span >Enjoy the read!</span></p><br><p dir="ltr" ><span ><span ><img></span></span></p><br><p dir="ltr" ><span >vision?</span></p><br><p dir="ltr" ><span >everyone means</span></p><!--EndFragment-->
