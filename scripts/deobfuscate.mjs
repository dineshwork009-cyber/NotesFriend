 ...
 *                      Default: https://app.notesfriend.com/assets/
 ...
 *                      Default: ~/.cache/notesfriend/sourcemaps
...
function parseArgs(argv) {
  const opts = {
    baseUrl: "https://app.notesfriend.com/assets/",
    cacheDir: path.join(os.homedir(), ".cache", "notesfriend", "sourcemaps"),
    localDir: null,
    noCache: false,
    context: 2,
    help: false,
