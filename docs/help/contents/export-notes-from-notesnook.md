...
description: Notesfriend is zero lock-in. You can always export and backup your notes to pdf, html, markdown and plain text files anytime from iOS, Android & Desktop.
---

# Exporting notes

You can export some or all your notes as PDF, HTML, Markdown and Plain text files on all Notesfriend apps.
...
3. Select the desired format
4. Wait a few moments while your note is exported
5. Exported notes are stored in `Notesfriend/exported` folder.
...
6. Exported notes are stored in `Notesfriend/exported` folder as a single .zip file
