...
2. Select Notesfriend from the list of apps.

# [iOS](#/tab/ios)

![Select Notesfriend](/static/mobile-integration/select-notesfriend-ios.png)

# [Android](#/tab/android)

![Select Notesfriend](/static/mobile-integration/select-notesfriend-android.png)

---

3. Tap on the Save button on bottom right corner to save the web clip. This will save the web clip as a new note in Notesfriend.
...
1. Share the webpage link to Notesfriend share extension
