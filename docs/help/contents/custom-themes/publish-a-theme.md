...
1. Go to [https://github.com/streetwriters/notesfriend-themes](https://github.com/streetwriters/notesfriend-themes) and "Fork" the repo. (Don't forget to "Star" it as well!)\
...
1. Go to your fork on GitHub. (Mine is at [https://github.com/ammarahm-ed/notesfriend-themes](https://github.com/ammarahm-ed/notesfriend-themes)).
