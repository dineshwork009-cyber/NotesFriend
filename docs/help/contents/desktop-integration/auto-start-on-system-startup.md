...
If your workflow requires Notesfriend to be always opened, it's a good idea to enable auto start on system startup:
...
Notesfriend can also start minimized when it's opened on system startup:
