...
>
> Notesfriend supports spell checking text in multiple languages at the same time. However, it doesn't ship all the supported languages but gives you the choice to enable the languages you want.
>
> Selecting a new language will **download the dictionary from `dictionaries.notesfriend.com`**.
