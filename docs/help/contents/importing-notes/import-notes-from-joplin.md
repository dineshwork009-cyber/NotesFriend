...
3. Open the Notesfriend app (web or desktop)
4. Go to `Settings > Notesfriend Importer` and select `Joplin` from list of apps.
...
6. Once the importing completes you should see all your notes in Notesfriend. If you face any issues during importing, feel free to [report them on GitHub](https://github.com/streetwriters/notesnook-importer).
