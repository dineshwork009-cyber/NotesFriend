...
3. Open the Notesfriend (app or desktop).
4. Go to `Settings > Notesfriend Importer` and select `Standard Notes` from list of apps.
...
6. Once importing completes you should see all your notes in Notesfriend. If you face any issues during importing, [report it on github](https://github.com/streetwriters/notesfriend).
