...
The following steps will help you quickly import your notes from Evernote into Notesfriend.
...
3. Choose `ENEX format` then click on `Export`, and save it to your desired location. Repeat this for all the Notebooks you want to import into Notesfriend.
   ![](/static/evernote-importer/3.png)

## Importing .ENEX files into Notesfriend

Once you have all the .ENEX files containing your Evernote notes, its time to import them into Notesfriend.

1. Open the Notesfriend app (web or desktop)
2. Go to `Settings > Notesfriend Importer` and select Evernote from the list of apps.
...
4. Once the importing completes you should see all your notes in Notesfriend. If you face any issues during importing, feel free to [report them on GitHub](https://github.com/streetwriters/notesnook-importer).

## Supported formats

Notesfriend Importer is one of the most robust Evernote importers, supporting almost 100% of Evernote formats. Here's a list of everything that can (or can't be) imported into Notesfriend:
