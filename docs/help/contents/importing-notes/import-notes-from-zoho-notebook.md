...
6. Go to `Settings > Notesfriend Importer` and select `Zoho notebook` from the list of apps.
...
8. Once importing completes you should see all your notes in Notesfriend. If you face any issues during importing, feel free to [report them on GitHub](https://github.com/streetwriters/notesnook-importer).
