...
The following steps will help you quickly import your notes from Skiff Pages into Notesfriend.
...
## Importing Skiff.zip file into Notesfriend

Once you have the `Skiff.zip` file containing your Skiff pages, its time to import them into Notesfriend.

1. Open the Notesfriend app (web or desktop)
2. Go to `Settings > Notesfriend Importer` and select "Skiff Pages".
