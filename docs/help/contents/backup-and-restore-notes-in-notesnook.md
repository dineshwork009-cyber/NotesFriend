...
description: Notesfriend allows you to backup all your notes data to a single backup file. Learn how you can backup your notes and restore them.
---
...
>
> Regardless of the folder you select, Notesfriend will create a folder "Notesfriend/backups" inside it and store all backup files there.
...
> info
>
> On the **web** app there is no way to automatically save backups to a folder, that is why Notesfriend only reminds the users when it's time to create a new backup.
...
At any point in time, you can restore a backup to recover lost data. However, **to restore a backup, you must be logged in to your Notesfriend account.** Backups created on one account can be restored on another Notesfriend account.
