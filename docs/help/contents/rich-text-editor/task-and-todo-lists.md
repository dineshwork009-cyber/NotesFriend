...
description: Create todo lists and manage your tasks in Notesfriend with ease using task lists.
---

# Task and todo lists

Create todo lists and manage your tasks in Notesfriend with ease using task lists.
...
Notesfriend supports unlimited subtasks under a single task item.
