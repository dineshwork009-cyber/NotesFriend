...
description: Clip web pages & save interesting things you find on the web with Notesfriend web clipper in a private & secure way.
---
...
Before you can clip pages, you must connect the web clipper with the Notesfriend web app. The web clipper works completely offline and relies on the web app to sync & save your clips.

1. Activate the web clipper by clicking on the Notesfriend icon in your browser toolbar

   > info Pin the Notesfriend Web Clipper to toolbar
   >
   > Modern browsers group all extensions under their Extensions dropdown by default. It is recommended that you `Pin to toolbar` the Notesfriend Web Clipper.
   >
   > # [Chrome](#/tab/chrome)
   >
   > ![How to pin the Notesfriend Web Clipper to toolbar in Chrome](/static/web-clipper/chrome-pin-to-toolbar.gif)
   >
   > # [Firefox](#/tab/firefox)
   >
   > ![How to pin the Notesfriend Web Clipper to toolbar in Firefox](/static/web-clipper/firefox-pin-to-toolbar.gif)
   >
   > ***

2. Click on `Connect to Notesfriend`
3. Notesfriend web app will open in a new tab in the background. Wait a few seconds and the web clipper should automatically connect.
   > error What to do if the web clipper doesn't connect?
   >
   > There are a few things you can do to troubleshoot:
   >
   > 1. Make sure you are logged in on the Notesfriend web app
   > 2. Make sure you have the Notesfriend web app opened in the background
...
The [web clipper](https://notesfriend.com/notesfriend-web-clipper) provides a few options to help you clip exactly the part of the page you need:

![Notesfriend Web Clipper clipping area options](/static/web-clipper/clipping-area.png)
...
1. Select the `Selected nodes` mode from the Notesfriend Web Clipper
...
6. Activate the Notesfriend Web Clipper and save your clip.
...
`Simplified` mode doesn't include any styles. It is best suited for long-form content such as articles & blogs. All clips in `Simplified` mode are saved directly as is i.e. they do not appear as web clip embeds in the Notesfriend editor.
...
`Complete with styles` mode saves all images, styles & everything on the page to retain the maximum amount of information. The final result appears as an embed in the Notesfriend editor which is full interactive.

![](/static/web-clipper/web-clip-embed.gif)

## Organizing your web clip

Notesfriend Web Clipper offers 3 easy ways to organize your web clips (all of which are completely optional):
