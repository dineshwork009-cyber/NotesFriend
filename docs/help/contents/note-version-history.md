...
Notesfriend keeps a constant log of all your edit sessions. These are stored as "versions" of a particular notes which you can view & restore to in case of data loss.

## How it works

Every time you create a new note or open an existing note, Notesfriend creates a "session" for it. All the changes made to the note are also stored in that session in addition to the note itself.
