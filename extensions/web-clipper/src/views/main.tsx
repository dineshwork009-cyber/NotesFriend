      ...
      >
        ...
        <Button
          ...
          onClick={async () => {
            ...
            const notesfriend = await connectApi(false);
            if (!notesfriend) {
              setError("You are not connected to Notesfriend.");
              return;
            }
            await notesfriend.saveClip({
              url,
              title,
              area: clipArea,
              mode: clipMode,
            ...
            await browser.notifications?.create({
              title: "Clip saved!",
              message: "Open the Notesfriend app to view the result.",
              type: "basic",
